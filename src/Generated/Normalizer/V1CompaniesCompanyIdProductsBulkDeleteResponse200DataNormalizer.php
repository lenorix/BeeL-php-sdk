...
class V1CompaniesCompanyIdProductsBulkDeleteResponse200DataNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CompaniesCompanyIdProductsBulkDeleteResponse200Data::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CompaniesCompanyIdProductsBulkDeleteResponse200Data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CompaniesCompanyIdProductsBulkDeleteResponse200Data;
        ...
        if (\array_key_exists('errors', $data)) {
            ...
            foreach ($data['errors'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, V1CompaniesCompanyIdProductsBulkDeleteResponse200DataErrorsItem::class, 'json', $context);
            }
            $object->setErrors($values_1);
            unset($data['errors']);
        }
        if (\array_key_exists('summary', $data)) {
            $object->setSummary($this->denormalizer->denormalize($data['summary'], V1CompaniesCompanyIdProductsBulkDeleteResponse200DataSummary::class, 'json', $context));
            unset($data['summary']);
        }
    ...
    {
        return [V1CompaniesCompanyIdProductsBulkDeleteResponse200Data::class => false];
    }
}
