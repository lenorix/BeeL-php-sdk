...
class RequestLogListResponseDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\RequestLogListResponseData::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\RequestLogListResponseData::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\RequestLogListResponseData();
        ...
        if (\array_key_exists('request_logs', $data)) {
            ...
            foreach ($data['request_logs'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Lenorix\BeelSdk\Generated\Model\RequestLogSummary::class, 'json', $context);
            }
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\RequestLogListResponseData::class => false];
    }
}