...
class EmailDeliveryIndicatorListResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === EmailDeliveryIndicatorListResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === EmailDeliveryIndicatorListResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new EmailDeliveryIndicatorListResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], EmailDeliveryIndicatorListResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [EmailDeliveryIndicatorListResponse::class => false];
    }
}
