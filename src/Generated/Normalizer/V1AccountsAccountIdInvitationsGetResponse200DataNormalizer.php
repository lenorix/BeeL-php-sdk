...
class V1AccountsAccountIdInvitationsGetResponse200DataNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1AccountsAccountIdInvitationsGetResponse200Data::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1AccountsAccountIdInvitationsGetResponse200Data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1AccountsAccountIdInvitationsGetResponse200Data;
        ...
        if (\array_key_exists('invitations', $data)) {
            ...
            foreach ($data['invitations'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, InvitationSummary::class, 'json', $context);
            }
    ...
    {
        return [V1AccountsAccountIdInvitationsGetResponse200Data::class => false];
    }
}
