...
class SetInvoiceStatusRequestPaymentMethodNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === SetInvoiceStatusRequestPaymentMethod::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === SetInvoiceStatusRequestPaymentMethod::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new SetInvoiceStatusRequestPaymentMethod;
    ...
    {
        return [SetInvoiceStatusRequestPaymentMethod::class => false];
    }
}
