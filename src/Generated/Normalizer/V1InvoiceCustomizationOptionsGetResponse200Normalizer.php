...
class V1InvoiceCustomizationOptionsGetResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1InvoiceCustomizationOptionsGetResponse200::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1InvoiceCustomizationOptionsGetResponse200::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1InvoiceCustomizationOptionsGetResponse200;
    ...
    {
        return [V1InvoiceCustomizationOptionsGetResponse200::class => false];
    }
}
