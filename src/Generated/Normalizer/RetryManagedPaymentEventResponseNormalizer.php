...
class RetryManagedPaymentEventResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === RetryManagedPaymentEventResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === RetryManagedPaymentEventResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new RetryManagedPaymentEventResponse;
    ...
    {
        return [RetryManagedPaymentEventResponse::class => false];
    }
}
