...
class V1ConfigurationSeriesDefaultsPostResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1ConfigurationSeriesDefaultsPostResponse200::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1ConfigurationSeriesDefaultsPostResponse200::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1ConfigurationSeriesDefaultsPostResponse200;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], V1ConfigurationSeriesDefaultsPostResponse200Data::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [V1ConfigurationSeriesDefaultsPostResponse200::class => false];
    }
}
