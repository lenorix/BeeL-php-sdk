...
class ResponseInvalidJsonFormatNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ResponseInvalidJsonFormat::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ResponseInvalidJsonFormat::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ResponseInvalidJsonFormat;
        ...
        if (\array_key_exists('error', $data)) {
            $object->setError($this->denormalizer->denormalize($data['error'], ResponseInvalidJsonFormatError::class, 'json', $context));
            unset($data['error']);
        }
    ...
    {
        return [ResponseInvalidJsonFormat::class => false];
    }
}
