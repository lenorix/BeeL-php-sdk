...
class V1CompaniesCompanyIdCustomersBulkPostResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CompaniesCompanyIdCustomersBulkPostResponse200::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CompaniesCompanyIdCustomersBulkPostResponse200::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CompaniesCompanyIdCustomersBulkPostResponse200;
    ...
    {
        return [V1CompaniesCompanyIdCustomersBulkPostResponse200::class => false];
    }
}
