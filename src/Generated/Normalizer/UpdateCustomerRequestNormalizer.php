...
class UpdateCustomerRequestNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === UpdateCustomerRequest::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === UpdateCustomerRequest::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new UpdateCustomerRequest;
        ...
        if (\array_key_exists('alternative_id', $data)) {
            $object->setAlternativeId($this->denormalizer->denormalize($data['alternative_id'], UpdateCustomerRequestAlternativeId::class, 'json', $context));
    ...
    {
        return [UpdateCustomerRequest::class => false];
    }
}
