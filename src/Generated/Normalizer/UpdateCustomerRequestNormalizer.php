...
class UpdateCustomerRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\UpdateCustomerRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\UpdateCustomerRequest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\UpdateCustomerRequest();
        ...
        if (\array_key_exists('alternative_id', $data)) {
            $object->setAlternativeId($this->denormalizer->denormalize($data['alternative_id'], \Lenorix\BeelSdk\Generated\Model\UpdateCustomerRequestAlternativeId::class, 'json', $context));
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\UpdateCustomerRequest::class => false];
    }
}