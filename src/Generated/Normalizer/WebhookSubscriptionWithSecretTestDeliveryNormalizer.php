...
class WebhookSubscriptionWithSecretTestDeliveryNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === WebhookSubscriptionWithSecretTestDelivery::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === WebhookSubscriptionWithSecretTestDelivery::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new WebhookSubscriptionWithSecretTestDelivery;
    ...
    {
        return [WebhookSubscriptionWithSecretTestDelivery::class => false];
    }
}
