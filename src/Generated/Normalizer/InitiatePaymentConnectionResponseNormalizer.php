...
class InitiatePaymentConnectionResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === InitiatePaymentConnectionResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === InitiatePaymentConnectionResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new InitiatePaymentConnectionResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], InitiatePaymentConnectionResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [InitiatePaymentConnectionResponse::class => false];
    }
}
