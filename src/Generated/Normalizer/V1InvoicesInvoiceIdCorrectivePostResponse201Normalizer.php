...
class V1InvoicesInvoiceIdCorrectivePostResponse201Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1InvoicesInvoiceIdCorrectivePostResponse201::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1InvoicesInvoiceIdCorrectivePostResponse201::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1InvoicesInvoiceIdCorrectivePostResponse201;
    ...
    {
        return [V1InvoicesInvoiceIdCorrectivePostResponse201::class => false];
    }
}
