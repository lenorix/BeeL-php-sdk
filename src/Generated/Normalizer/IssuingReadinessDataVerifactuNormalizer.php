...
class IssuingReadinessDataVerifactuNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === IssuingReadinessDataVerifactu::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === IssuingReadinessDataVerifactu::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new IssuingReadinessDataVerifactu;
    ...
    {
        return [IssuingReadinessDataVerifactu::class => false];
    }
}
