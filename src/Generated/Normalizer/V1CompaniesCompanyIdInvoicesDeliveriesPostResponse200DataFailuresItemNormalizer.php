...
class V1CompaniesCompanyIdInvoicesDeliveriesPostResponse200DataFailuresItemNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CompaniesCompanyIdInvoicesDeliveriesPostResponse200DataFailuresItem::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CompaniesCompanyIdInvoicesDeliveriesPostResponse200DataFailuresItem::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CompaniesCompanyIdInvoicesDeliveriesPostResponse200DataFailuresItem;
    ...
    {
        return [V1CompaniesCompanyIdInvoicesDeliveriesPostResponse200DataFailuresItem::class => false];
    }
}
