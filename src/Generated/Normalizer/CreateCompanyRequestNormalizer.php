...
class CreateCompanyRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\CreateCompanyRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\CreateCompanyRequest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\CreateCompanyRequest();
        ...
        if (\array_key_exists('activate', $data) && \is_int($data['activate'])) {
            $data['activate'] = (bool) $data['activate'];
        }
        ...
        if (\array_key_exists('numbering', $data)) {
            $object->setNumbering($this->denormalizer->denormalize($data['numbering'], \Lenorix\BeelSdk\Generated\Model\CompanyNumbering::class, 'json', $context));
            unset($data['numbering']);
        }
        if (\array_key_exists('aeat_environment', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('numbering') && null !== $data->getNumbering()) {
            $dataArray['numbering'] = $data->getNumbering() === null ? null : new \Lenorix\BeelSdk\Generated\Runtime\JsonObject($this->normalizer->normalize($data->getNumbering(), 'json', $context));
        }
        if ($data->isInitialized('aeatEnvironment') && null !== $data->getAeatEnvironment()) {
            $dataArray['aeat_environment'] = $data->getAeatEnvironment();
        }
        if ($data->isInitialized('activate') && null !== $data->getActivate()) {
            $dataArray['activate'] = $data->getActivate();
        }
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\CreateCompanyRequest::class => false];
    }
}