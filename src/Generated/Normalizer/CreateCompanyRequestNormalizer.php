...
class CreateCompanyRequestNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === CreateCompanyRequest::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === CreateCompanyRequest::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new CreateCompanyRequest;
        ...
        if (\array_key_exists('numbering', $data)) {
            $object->setNumbering($this->denormalizer->denormalize($data['numbering'], CompanyNumbering::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('numbering') && $data->getNumbering() !== null) {
            $dataArray['numbering'] = $data->getNumbering() === null ? null : new JsonObject($this->normalizer->normalize($data->getNumbering(), 'json', $context));
        }
        if ($data->isInitialized('aeatEnvironment') && $data->getAeatEnvironment() !== null) {
            $dataArray['aeat_environment'] = $data->getAeatEnvironment();
        }
        if ($data->isInitialized('activate') && $data->getActivate() !== null) {
    ...
    {
        return [CreateCompanyRequest::class => false];
    }
}
