...
class ProvisionAccountRequestTaxProfileNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ProvisionAccountRequestTaxProfile::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ProvisionAccountRequestTaxProfile::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ProvisionAccountRequestTaxProfile;
    ...
    {
        return [ProvisionAccountRequestTaxProfile::class => false];
    }
}
