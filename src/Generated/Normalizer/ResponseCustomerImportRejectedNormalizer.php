...
class ResponseCustomerImportRejectedNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\ResponseCustomerImportRejected::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\ResponseCustomerImportRejected::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\ResponseCustomerImportRejected();
        ...
        if (\array_key_exists('error', $data)) {
            $object->setError($this->denormalizer->denormalize($data['error'], \Lenorix\BeelSdk\Generated\Model\ResponseCustomerImportRejectedError::class, 'json', $context));
            unset($data['error']);
        }
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\ResponseCustomerImportRejected::class => false];
    }
}