...
class ResponseCustomerImportRejectedNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ResponseCustomerImportRejected::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ResponseCustomerImportRejected::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ResponseCustomerImportRejected;
        ...
        if (\array_key_exists('error', $data)) {
            $object->setError($this->denormalizer->denormalize($data['error'], ResponseCustomerImportRejectedError::class, 'json', $context));
            unset($data['error']);
        }
    ...
    {
        return [ResponseCustomerImportRejected::class => false];
    }
}
