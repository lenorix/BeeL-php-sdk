...
class V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdGetResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdGetResponse200::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdGetResponse200::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdGetResponse200;
    ...
    {
        return [V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdGetResponse200::class => false];
    }
}
