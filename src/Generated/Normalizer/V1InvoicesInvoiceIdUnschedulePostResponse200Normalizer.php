...
class V1InvoicesInvoiceIdUnschedulePostResponse200Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1InvoicesInvoiceIdUnschedulePostResponse200::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1InvoicesInvoiceIdUnschedulePostResponse200::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1InvoicesInvoiceIdUnschedulePostResponse200;
    ...
    {
        return [V1InvoicesInvoiceIdUnschedulePostResponse200::class => false];
    }
}
