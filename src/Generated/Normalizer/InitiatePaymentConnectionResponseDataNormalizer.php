...
class InitiatePaymentConnectionResponseDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('authorization_url', $data)) {
            $object->setAuthorizationUrl($data['authorization_url']);
            unset($data['authorization_url']);
        }
    ...
    {
        $dataArray = [];
        $dataArray['authorization_url'] = $data->getAuthorizationUrl();
