...
class RepresentationActionResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === RepresentationActionResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === RepresentationActionResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new RepresentationActionResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], RepresentationActionResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [RepresentationActionResponse::class => false];
    }
}
