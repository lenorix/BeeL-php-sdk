...
class CreateInvoiceRequestLinesItemMainTaxNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === CreateInvoiceRequestLinesItemMainTax::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === CreateInvoiceRequestLinesItemMainTax::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new CreateInvoiceRequestLinesItemMainTax;
    ...
    {
        return [CreateInvoiceRequestLinesItemMainTax::class => false];
    }
}
