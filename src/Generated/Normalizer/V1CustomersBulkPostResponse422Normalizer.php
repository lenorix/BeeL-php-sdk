...
class V1CustomersBulkPostResponse422Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CustomersBulkPostResponse422::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CustomersBulkPostResponse422::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CustomersBulkPostResponse422;
        ...
        if (\array_key_exists('error', $data)) {
            $object->setError($this->denormalizer->denormalize($data['error'], V1CustomersBulkPostResponse422Error::class, 'json', $context));
            unset($data['error']);
        }
    ...
    {
        return [V1CustomersBulkPostResponse422::class => false];
    }
}
