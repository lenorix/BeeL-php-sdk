...
class V1AccountsGetResponse200DataNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1AccountsGetResponse200Data::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1AccountsGetResponse200Data::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1AccountsGetResponse200Data;
        ...
        if (\array_key_exists('accounts', $data)) {
            ...
            foreach ($data['accounts'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, ManagedAccountSummary::class, 'json', $context);
            }
    ...
    {
        return [V1AccountsGetResponse200Data::class => false];
    }
}
