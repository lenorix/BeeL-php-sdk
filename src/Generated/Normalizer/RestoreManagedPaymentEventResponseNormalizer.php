...
class RestoreManagedPaymentEventResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === RestoreManagedPaymentEventResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === RestoreManagedPaymentEventResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new RestoreManagedPaymentEventResponse;
    ...
    {
        return [RestoreManagedPaymentEventResponse::class => false];
    }
}
