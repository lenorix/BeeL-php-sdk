...
class V1ProductsBulkDeleteResponse200DataSummaryNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1ProductsBulkDeleteResponse200DataSummary::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1ProductsBulkDeleteResponse200DataSummary::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1ProductsBulkDeleteResponse200DataSummary;
    ...
    {
        return [V1ProductsBulkDeleteResponse200DataSummary::class => false];
    }
}
