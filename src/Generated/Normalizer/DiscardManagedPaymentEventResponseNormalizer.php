...
class DiscardManagedPaymentEventResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === DiscardManagedPaymentEventResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === DiscardManagedPaymentEventResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new DiscardManagedPaymentEventResponse;
    ...
    {
        return [DiscardManagedPaymentEventResponse::class => false];
    }
}
