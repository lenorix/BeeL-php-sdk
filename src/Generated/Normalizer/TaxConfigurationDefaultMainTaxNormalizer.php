...
class TaxConfigurationDefaultMainTaxNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === TaxConfigurationDefaultMainTax::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === TaxConfigurationDefaultMainTax::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new TaxConfigurationDefaultMainTax;
    ...
    {
        return [TaxConfigurationDefaultMainTax::class => false];
    }
}
