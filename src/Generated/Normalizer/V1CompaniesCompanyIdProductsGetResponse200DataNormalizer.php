...
class V1CompaniesCompanyIdProductsGetResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\V1CompaniesCompanyIdProductsGetResponse200Data::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\V1CompaniesCompanyIdProductsGetResponse200Data::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\V1CompaniesCompanyIdProductsGetResponse200Data();
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\V1CompaniesCompanyIdProductsGetResponse200Data::class => false];
    }
}