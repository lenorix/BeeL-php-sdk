...
class PatchCustomerRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequest::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequest();
        ...
        if (\array_key_exists('alternative_id', $data)) {
            $object->setAlternativeId($this->denormalizer->denormalize($data['alternative_id'], \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequestAlternativeId::class, 'json', $context));
        ...
        if (\array_key_exists('address', $data)) {
            $object->setAddress($this->denormalizer->denormalize($data['address'], \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequestAddress::class, 'json', $context));
            unset($data['address']);
        }
        ...
        if (\array_key_exists('preferred_payment_method', $data)) {
            $object->setPreferredPaymentMethod($this->denormalizer->denormalize($data['preferred_payment_method'], \Lenorix\BeelSdk\Generated\Model\PatchCustomerRequestPreferredPaymentMethod::class, 'json', $context));
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\PatchCustomerRequest::class => false];
    }
}