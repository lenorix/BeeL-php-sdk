...
class ProductsListResponseDataNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ProductsListResponseData::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ProductsListResponseData::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ProductsListResponseData;
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('products') && $data->getProducts() !== null) {
            $values = [];
    ...
    {
        return [ProductsListResponseData::class => false];
    }
}
