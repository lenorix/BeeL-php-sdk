...
class ManagedPaymentEventDraftResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ManagedPaymentEventDraftResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ManagedPaymentEventDraftResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ManagedPaymentEventDraftResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], ManagedPaymentEventDraftResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [ManagedPaymentEventDraftResponse::class => false];
    }
}
