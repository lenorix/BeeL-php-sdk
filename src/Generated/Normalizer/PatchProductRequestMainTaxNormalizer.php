...
class PatchProductRequestMainTaxNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === PatchProductRequestMainTax::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === PatchProductRequestMainTax::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new PatchProductRequestMainTax;
    ...
    {
        return [PatchProductRequestMainTax::class => false];
    }
}
