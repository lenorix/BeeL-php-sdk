...
class ListCompanyStats200ResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ListCompanyStats200Response::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ListCompanyStats200Response::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ListCompanyStats200Response;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], ListCompanyStats200ResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [ListCompanyStats200Response::class => false];
    }
}
