...
class VeriFactuNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Lenorix\BeelSdk\Generated\Model\VeriFactu::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Lenorix\BeelSdk\Generated\Model\VeriFactu::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Lenorix\BeelSdk\Generated\Model\VeriFactu();
        ...
        if (\array_key_exists('registered_at', $data)) {
            ...
            if (false === $date) {
                throw new \Lenorix\BeelSdk\Generated\Runtime\Normalizer\InvalidDateException($data['registered_at'], 'Y-m-d\TH:i:sP');
            }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('chainingHash') && null !== $data->getChainingHash()) {
        ...
        if ($data->isInitialized('skipReason') && null !== $data->getSkipReason()) {
    ...
    {
        return [\Lenorix\BeelSdk\Generated\Model\VeriFactu::class => false];
    }
}