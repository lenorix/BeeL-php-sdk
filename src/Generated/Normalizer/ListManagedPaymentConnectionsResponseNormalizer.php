...
class ListManagedPaymentConnectionsResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ListManagedPaymentConnectionsResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ListManagedPaymentConnectionsResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ListManagedPaymentConnectionsResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], ListManagedPaymentConnectionsResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [ListManagedPaymentConnectionsResponse::class => false];
    }
}
