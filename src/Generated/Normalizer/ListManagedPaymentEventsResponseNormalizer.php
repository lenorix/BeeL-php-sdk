...
class ListManagedPaymentEventsResponseNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === ListManagedPaymentEventsResponse::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === ListManagedPaymentEventsResponse::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new ListManagedPaymentEventsResponse;
        ...
        if (\array_key_exists('data', $data)) {
            $object->setData($this->denormalizer->denormalize($data['data'], ListManagedPaymentEventsResponseData::class, 'json', $context));
            unset($data['data']);
        }
    ...
    {
        return [ListManagedPaymentEventsResponse::class => false];
    }
}
