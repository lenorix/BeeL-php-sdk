...
class V1CompaniesCompanyIdSeriesGetResponse200DataPaginationNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1CompaniesCompanyIdSeriesGetResponse200DataPagination::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1CompaniesCompanyIdSeriesGetResponse200DataPagination::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1CompaniesCompanyIdSeriesGetResponse200DataPagination;
    ...
    {
        return [V1CompaniesCompanyIdSeriesGetResponse200DataPagination::class => false];
    }
}
