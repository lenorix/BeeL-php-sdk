...
class V1InvoicesInvoiceIdDuplicatePostResponse201Normalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === V1InvoicesInvoiceIdDuplicatePostResponse201::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === V1InvoicesInvoiceIdDuplicatePostResponse201::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new V1InvoicesInvoiceIdDuplicatePostResponse201;
    ...
    {
        return [V1InvoicesInvoiceIdDuplicatePostResponse201::class => false];
    }
}
