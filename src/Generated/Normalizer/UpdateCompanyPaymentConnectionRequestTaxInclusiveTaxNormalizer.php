...
class UpdateCompanyPaymentConnectionRequestTaxInclusiveTaxNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === UpdateCompanyPaymentConnectionRequestTaxInclusiveTax::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === UpdateCompanyPaymentConnectionRequestTaxInclusiveTax::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new UpdateCompanyPaymentConnectionRequestTaxInclusiveTax;
    ...
    {
        return [UpdateCompanyPaymentConnectionRequestTaxInclusiveTax::class => false];
    }
}
