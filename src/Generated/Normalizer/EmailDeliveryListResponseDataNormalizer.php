...
class EmailDeliveryListResponseDataNormalizer implements DenormalizerAwareInterface, DenormalizerInterface, NormalizerAwareInterface, NormalizerInterface
{
    use CheckArray;
    ...
    {
        return $type === EmailDeliveryListResponseData::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === EmailDeliveryListResponseData::class;
    }

    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new EmailDeliveryListResponseData;
        ...
        if (\array_key_exists('emails', $data)) {
            ...
            foreach ($data['emails'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, EmailDeliveryResponse::class, 'json', $context);
            }
    ...
    {
        return [EmailDeliveryListResponseData::class => false];
    }
}
