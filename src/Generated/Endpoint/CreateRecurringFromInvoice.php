...
class CreateRecurringFromInvoice extends BaseEndpoint implements Endpoint
{
     ...
     * } $headerParameters
     */
    public function __construct(string $invoiceId, CreateRecurringFromInvoiceRequest $requestBody, array $headerParameters = [])
    {
    ...
    {
        if ($this->body instanceof CreateRecurringFromInvoiceRequest) {
    ...
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && ($status === 403 && stripos(strtolower($contentType), 'application/json') !== false)) {
            throw new CreateRecurringFromInvoiceForbiddenException($serializer->deserialize($body, 'Lenorix\BeelSdk\Generated\Model\ErrorResponse', 'json'), $response);
        }
        if (is_null($contentType) === false && ($status === 404 && stripos(strtolower($contentType), 'application/json') !== false)) {
            throw new CreateRecurringFromInvoiceNotFoundException($serializer->deserialize($body, 'Lenorix\BeelSdk\Generated\Model\ErrorResponse', 'json'), $response);
        }
