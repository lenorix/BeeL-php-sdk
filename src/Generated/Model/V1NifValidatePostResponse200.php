...
class V1NifValidatePostResponse200 implements AdditionalPropertiesInterface
{
     ...
     */
    public function getData(): ValidateNifResponse
    {
        return $this->data;
    }
    /**
     * @param ValidateNifResponse $data
     *
     * @return self
     */
    public function setData(ValidateNifResponse $data): self
    {
