...
class ResponseCustomerImportRejected implements AdditionalPropertiesInterface
{
    ...
    protected $success;
    /**
     * @var ResponseCustomerImportRejectedError
     */
    protected $error;
    /**
     * @var ResponseMeta
    ...
    /**
     * @return ResponseCustomerImportRejectedError
     */
    public function getError(): ResponseCustomerImportRejectedError
    {
        return $this->error;
    }
    /**
     * @param ResponseCustomerImportRejectedError $error
     *
     * @return self
     */
    public function setError(ResponseCustomerImportRejectedError $error): self
    {
