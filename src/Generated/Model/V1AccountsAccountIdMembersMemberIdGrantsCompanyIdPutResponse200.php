...
class V1AccountsAccountIdMembersMemberIdGrantsCompanyIdPutResponse200 implements AdditionalPropertiesInterface
{
     ...
     */
    public function getData(): GrantAssignment
    {
        return $this->data;
    }
    /**
     * A member's access to a specific company.
     *
     * @param GrantAssignment $data
     *
     * @return self
     */
    public function setData(GrantAssignment $data): self
    {
