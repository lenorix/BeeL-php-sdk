...
class V1CustomersBulkPostResponse422 implements AdditionalPropertiesInterface
{
    ...
    protected $success;
    /**
     * @var V1CustomersBulkPostResponse422Error
     */
    protected $error;
    /**
     * @var ResponseMeta
    ...
    /**
     * @return V1CustomersBulkPostResponse422Error
     */
    public function getError(): V1CustomersBulkPostResponse422Error
    {
        return $this->error;
    }
    /**
     * @param V1CustomersBulkPostResponse422Error $error
     *
     * @return self
     */
    public function setError(V1CustomersBulkPostResponse422Error $error): self
    {
