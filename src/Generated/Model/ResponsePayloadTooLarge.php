...
class ResponsePayloadTooLarge implements AdditionalPropertiesInterface
{
    ...
    protected $success;
    /**
     * @var ResponsePayloadTooLargeError
     */
    protected $error;
    /**
     * @var ResponseMeta
    ...
    /**
     * @return ResponsePayloadTooLargeError
     */
    public function getError(): ResponsePayloadTooLargeError
    {
        return $this->error;
    }
    /**
     * @param ResponsePayloadTooLargeError $error
     *
     * @return self
     */
    public function setError(ResponsePayloadTooLargeError $error): self
    {
