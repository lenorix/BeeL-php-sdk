...
class V1CompaniesCompanyIdTaxConfigurationPutResponse200 implements AdditionalPropertiesInterface
{
     ...
     */
    public function getData(): TaxConfiguration
    {
        return $this->data;
    }
    /**
     * @param TaxConfiguration $data
     *
     * @return self
     */
    public function setData(TaxConfiguration $data): self
    {
