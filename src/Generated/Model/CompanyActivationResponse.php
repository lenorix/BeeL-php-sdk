...
class CompanyActivationResponse implements AdditionalPropertiesInterface
{
     ...
     */
    public function getData(): CompanyActivation
    {
        return $this->data;
    }
    /**
     * @param CompanyActivation $data
     *
     * @return self
     */
    public function setData(CompanyActivation $data): self
    {
