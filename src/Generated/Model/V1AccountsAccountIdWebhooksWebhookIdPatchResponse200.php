...
class V1AccountsAccountIdWebhooksWebhookIdPatchResponse200 implements AdditionalPropertiesInterface
{
    ...
    public function getData(): WebhookSubscription
    {
        return $this->data;
    }

    public function setData(WebhookSubscription $data): self
    {
