...
class V1CompaniesCompanyIdFiscalSummaryGetResponse200 implements AdditionalPropertiesInterface
{
     ...
     * Comprehensive fiscal summary for a period
     */
    public function getData(): FiscalSummaryResponse
    {
        return $this->data;
    }
     ...
     * Comprehensive fiscal summary for a period
     */
    public function setData(FiscalSummaryResponse $data): self
    {
