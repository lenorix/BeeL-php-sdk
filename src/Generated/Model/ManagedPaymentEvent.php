...
class ManagedPaymentEvent implements AdditionalPropertiesInterface
{
    ...
    *
    * @param string|null $sourceObjectId
    *
    * @return self
    */
    ...
    */
     ...
     * When the event was discarded, when it is.
     *
     * @param \DateTime|null $discardedAt
     *
     * @return self
     */
