...
class V1CompaniesCompanyIdLogoPutResponse200 implements AdditionalPropertiesInterface
{
     ...
     * @return CompanyLogo
     */
    public function getData(): CompanyLogo
    {
        return $this->data;
    }
    /**
     ...
     * @return self
     */
    public function setData(CompanyLogo $data): self
    {
