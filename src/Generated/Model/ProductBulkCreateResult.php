...
class ProductBulkCreateResult implements AdditionalPropertiesInterface
{
     ...
     * What the operation was, and whether it was a rehearsal.
     *
     * @return ProductBulkCreateMetadata
     */
     ...
     * What the operation was, and whether it was a rehearsal.
     *
     * @param ProductBulkCreateMetadata $metadata
     *
     * @return self
     */
    ...
    */
     ...
     * 
     *
     * @return ProductBulkCreateStatistics
     */
    ...
    *
    * @param ProductBulkCreateStatistics $statistics
    *
    * @return self
    */
