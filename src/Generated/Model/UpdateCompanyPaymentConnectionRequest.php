...
class UpdateCompanyPaymentConnectionRequest implements AdditionalPropertiesInterface
{
    ...
    */
     ...
     * 
     *
     * @return UpdateCompanyPaymentConnectionRequestTaxInclusiveTax|null
     */
    ...
    *
    * @param UpdateCompanyPaymentConnectionRequestTaxInclusiveTax|null $taxInclusiveTax
    *
    * @return self
    */
     ...
     * 
     *
     * @return UpdateCompanyPaymentConnectionSeries
     */
    ...
    *
    * @param UpdateCompanyPaymentConnectionSeries $series
    *
    * @return self
    */
    ...
    */
     ...
     * 
     *
     * @return UpdateCompanyPaymentConnectionRequestFilterConfig
     */
    ...
    *
    * @param UpdateCompanyPaymentConnectionRequestFilterConfig $filterConfig
    *
    * @return self
    */
