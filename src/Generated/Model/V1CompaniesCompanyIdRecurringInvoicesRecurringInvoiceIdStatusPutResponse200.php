...
class V1CompaniesCompanyIdRecurringInvoicesRecurringInvoiceIdStatusPutResponse200 implements AdditionalPropertiesInterface
{
    ...
    /**
     * @param RecurringInvoiceResponse $data
     *
     * @return self
     */
